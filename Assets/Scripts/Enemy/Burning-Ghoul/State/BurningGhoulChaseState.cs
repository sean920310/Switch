...
public class BurningGhoulChaseState : BurningGhoulBaseState
{
    public BurningGhoulChaseState(BurningGhoulStateManager context, BurningGhoulStateFactory factory)
