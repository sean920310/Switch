...
public class BurningGhoulPatrolState : BurningGhoulBaseState
{
    private bool turningWait;
    public BurningGhoulPatrolState(BurningGhoulStateManager context, BurningGhoulStateFactory factory)
